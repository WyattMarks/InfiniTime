...
void WatchFaceHorizon::Refresh() {
  ...
  if (currentDateTime.IsUpdated()) {
    ...
    auto month = dateTimeController.Month();//static_cast<Pinetime::Controllers::DateTime::Months>(static_cast<unsigned>(yearMonthDay.month()));
    auto day = dateTimeController.Day();//static_cast<unsigned>(yearMonthDay.day());
    auto dayOfWeek = dateTimeController.DayOfWeek();//static_cast<Pinetime::Controllers::DateTime::Days>(date::weekday(yearMonthDay).iso_encoding());
